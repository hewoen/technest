<x-app-layout>
    <div class="container ">
        ...
        @endif
        <div class="card">
            <div class="card-header d-flex justify-content-between">Produkt hinzufügen <a href="{{ route('dashboard') }}"
            ...
            <div class="card-body">
                <div class="col-md-auto">
                    <form enctype="multipart/form-data" method="POST" action="{{ route('products.store') }}">
                        ...
                        <button type="submit" class="btn btn-primary mt-2">Produkt erstellen</button>
                    </form>
                </div>
            </div>
        </div>
